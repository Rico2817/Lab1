<%@ page import="com.LiQijun.model.Product" %>
<%@ page import="com.LiQijun.model.Category" %>
					...
					<c:forEach var="p" items="${productList}">
						<tr>
							...
							<%
								...
								com.LiQijun.model.Product p=(com.LiQijun.model.Product)pageContext.findAttribute("p");
